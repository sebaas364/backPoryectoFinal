...
public class UsuarioController {
	...
	@PutMapping("/update")
	public ResponseEntity<String> update(@RequestParam Integer id, @RequestParam String newUsername, @RequestParam String newCorreo,
			@RequestParam String newPassword, @RequestParam(required = true) String role) {
